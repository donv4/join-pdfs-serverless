...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></div></div><div class="mt-8"><div class="p-4 font-mono text-sm leading-6 bg-white border border-slate-300 whitespace-pre overflow-x-auto" style="tab-size:2;"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;module&quot;</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;https://unpkg.com/run&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></div></div><p class="mt-8">You can add the following attributes to inline <code class="text-sm bg-slate-100">script</code> tags handled by <code>/run</code>:</p><div class="mt-8 overflow-x-auto"><table class="w-full text-left text-sm border-collapse"><thead><tr class="border-b border-slate-300"><th class="py-2 pr-4 font-semibold">Attribute</th><th class="py-2 font-semibold">Use</th></tr></thead><tbody><tr class="border-b border-slate-200"><td class="py-2 pr-4 whitespace-nowrap"><code class="text-sm bg-slate-100">data-filename</code></td><td class="py-2">Names the inline file for extension inference and clearer diagnostics.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 whitespace-nowrap"><code class="text-sm bg-slate-100">data-target</code></td><td class="py-2">Sets the JavaScript output target, such as <code>es2022</code>.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 whitespace-nowrap"><code class="text-sm bg-slate-100">data-jsx</code></td><td class="py-2">Chooses JSX mode, such as <code>automatic</code>.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 whitespace-nowrap"><code class="text-sm bg-slate-100">data-jsx-import-source</code></td><td class="py-2">Sets the JSX import source, such as <code>preact</code>.</td></tr><tr><td class="py-2 pr-4 whitespace-nowrap"><code class="text-sm bg-slate-100">data-dev</code></td><td class="py-2">Enables development-mode JSX output.</td></tr></tbody></table></div></section><section id="browser-modules"><h2 class="mt-16 mb-8 text-lg font-semibold group">Browser Modules <a class="outline-none after:content-['#'] after:ml-1 after:text-slate-300 after:opacity-0 group-hover:after:opacity-100 after:transition-opacity" href="#browser-modules"></a></h2><p class="mt-4">For packages that are not already published as browser-ready ESM files, use <a class="text-blue-600 hover:underline" href="https://esm.unpkg.com/">esm.unpkg.com</a>. This subdomain resolves npm packages, transforms TypeScript and JSX when needed, bundles package internals, rewrites dependency imports to permanent UNPKG URLs, and returns modules that can be loaded directly in modern browsers.</p><div class="mt-8"><div class="p-4 font-mono text-sm leading-6 bg-white border border-slate-300 whitespace-pre overflow-x-auto" style="tab-size:2;"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;module&quot;</span>&gt;</span><span class="language-javascript">
...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></div></div><p class="mt-8">The URL format is the same package URL style you use on UNPKG, but on the <code class="text-sm bg-slate-100">esm.unpkg.com</code> subdomain:</p><div class="mt-8"><div class="p-4 font-mono text-sm leading-6 bg-white border border-slate-300 whitespace-pre overflow-x-auto" style="tab-size:2;"><span class="hljs-symbol">https:</span>/<span class="hljs-regexp">/esm.unpkg.com/</span><span class="hljs-symbol">:package</span>@<span class="hljs-symbol">:version/</span><span class="hljs-symbol">:subpath</span></div></div><p class="mt-8">Versions may be exact versions, npm dist-tags, or semver ranges. If you omit the version, the <code class="text-sm bg-slate-100">latest</code> tag is used. Requests redirect to a normalized, version-pinned URL so generated module imports are stable and cacheable.</p><ul class="mt-4 ml-6 list-disc list-outside"><li><a class="text-blue-600 hover:underline break-all" href="https://esm.unpkg.com/preact">esm.unpkg.com/preact</a></li><li><a class="text-blue-600 hover:underline break-all" href="https://esm.unpkg.com/react-dom@18/client">esm.unpkg.com/react-dom@18/client</a></li><li><a class="text-blue-600 hover:underline break-all" href="https://esm.unpkg.com/@floating-ui/dom@1">esm.unpkg.com/@floating-ui/dom@1</a></li></ul><p class="mt-8">By default, esm.unpkg.com targets modern browsers with <code class="text-sm bg-slate-100">target=es2022</code>, uses production mode, bundles internal package files, leaves dependency packages as rewritten imports, and attaches TypeScript declaration metadata when it can find it.</p><p class="mt-8">The following query parameters are available:</p><div class="mt-4 overflow-x-auto"><table class="w-full text-left text-sm border-collapse"><thead><tr class="border-b border-slate-300"><th class="py-2 pr-4 font-semibold">Parameter</th><th class="py-2 font-semibold">Use</th></tr></thead><tbody><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?target=...</code></td><td class="py-2 align-top">Chooses the output/runtime target. Supported values are <code class="text-sm bg-slate-100">es2015</code> through <code class="text-sm bg-slate-100">es2024</code>, <code class="text-sm bg-slate-100">esnext</code>, <code class="text-sm bg-slate-100">node</code>, <code class="text-sm bg-slate-100">deno</code>, and <code class="text-sm bg-slate-100">denonext</code>.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?dev</code>, <code class="text-sm bg-slate-100">?env=development</code></td><td class="py-2 align-top">Builds with development conditions and replaces <code class="text-sm bg-slate-100">process.env.NODE_ENV</code> with <code class="text-sm bg-slate-100">&quot;development&quot;</code>. The default is <code class="text-sm bg-slate-100">env=production</code>.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?conditions=...</code></td><td class="py-2 align-top">Adds custom package export conditions. You may pass a comma-separated list or repeat the parameter.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?deps=react@18.3.1,react-dom@18.3.1</code></td><td class="py-2 align-top">Overrides dependency versions used when rewriting imports.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?alias=react:preact/compat</code></td><td class="py-2 align-top">Rewrites package specifiers to alternate packages or subpaths.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?external=react,react-dom</code></td><td class="py-2 align-top">Leaves matching dependencies as bare imports. Use <code class="text-sm bg-slate-100">?external=*</code> to externalize all dependencies, or use the shorthand <code class="text-sm bg-slate-100">/*pkg</code> form, such as <code class="text-sm bg-slate-100">https://esm.unpkg.com/*swr@2</code>.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?bundle</code>, <code class="text-sm bg-slate-100">?standalone</code>, <code class="text-sm bg-slate-100">?no-bundle</code></td><td class="py-2 align-top">Controls dependency bundling. <code class="text-sm bg-slate-100">?bundle=false</code> also disables bundling.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?jsx=automatic</code>, <code class="text-sm bg-slate-100">?jsxImportSource=...</code></td><td class="py-2 align-top">Selects JSX transform mode. Use <code class="text-sm bg-slate-100">?jsx=react</code> or <code class="text-sm bg-slate-100">?jsx=preact</code> for classic presets.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?min</code>, <code class="text-sm bg-slate-100">?sourcemap</code>, <code class="text-sm bg-slate-100">?keep-names</code>, <code class="text-sm bg-slate-100">?ignore-annotations</code></td><td class="py-2 align-top">Controls output minification, inline source maps, function/class names, and tree-shaking annotations.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?no-dts</code></td><td class="py-2 align-top">Suppresses the <code class="text-sm bg-slate-100">X-TypeScript-Types</code> response header when declaration files are available.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?meta</code></td><td class="py-2 align-top">Returns JSON metadata for the resolved module, including dependencies, export subpaths, target, bundle mode, types URL, and integrity.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?raw</code></td><td class="py-2 align-top">Serves the raw package file without transforming it. Raw mode cannot be combined with build options like <code class="text-sm bg-slate-100">?target</code>, <code class="text-sm bg-slate-100">?bundle</code>, or <code class="text-sm bg-slate-100">?min</code>.</td></tr><tr class="border-b border-slate-200"><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?css</code>, <code class="text-sm bg-slate-100">?module</code></td><td class="py-2 align-top">Requests package stylesheet entries or returns constructable stylesheet modules for <code class="text-sm bg-slate-100">.css</code> files.</td></tr><tr><td class="py-2 pr-4 align-top break-all"><code class="text-sm bg-slate-100">?worker</code></td><td class="py-2 align-top">Returns a small module that creates a <code class="text-sm bg-slate-100">new Worker(url, { type: &quot;module&quot; })</code> for the resolved module URL.</td></tr></tbody></table></div><p class="mt-8">Stylesheet packages and stylesheet files can be loaded from the same npm URLs. Direct <code class="text-sm bg-slate-100">.css</code> files are served as CSS, package roots with stylesheet metadata redirect to their stylesheet entry, and <code class="text-sm bg-slate-100">?module</code> turns a CSS file into a constructable <code class="text-sm bg-slate-100">CSSStyleSheet</code> module.</p><div class="mt-8"><div class="p-4 font-mono text-sm leading-6 bg-white border border-slate-300 whitespace-pre overflow-x-auto" style="tab-size:2;"><span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">&quot;stylesheet&quot;</span> <span class="hljs-attr">href</span>=<span class="hljs-string">&quot;https://esm.unpkg.com/bootstrap@5.3.8/dist/css/bootstrap.min.css&quot;</span>&gt;</span>
